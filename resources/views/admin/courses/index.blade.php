...
@section('container')
            ...
            <div class="col-12 col-md-7">
                ...
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                    <ul class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item"><a href="/dashboard">All Courses</a></li>
                    </ul>
                </nav>
            </div>
            <!-- Title End -->
    ...
    <div class="table-responsive col-lg-10">
      <a href="/upload" class="btn btn-primary mb-3">Upload New Video</a>
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <tr>
              <td>1</td>
              <td><img src="img/thumbnail/html.jpg" width="50" alt=""></td>
              <td>Belajar HTML</td>
            ...
            <tr>
              <td>2</td>
              <td><img src="img/thumbnail/css.png" width="50" alt=""></td>
              <td>Belajar CSS</td>
              <td>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit, nisi!</td>
              <td>
                <a class="badge bg-warning border-0" href="/crud">Edit</a>
            ...
            <tr>
              <td>3</td>
              <td><img src="img/thumbnail/laravel.jpg" width="50" alt=""></td>
