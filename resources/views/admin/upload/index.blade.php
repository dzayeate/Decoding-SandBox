            ...
            <div class="col">
              ...
              <div class="page-title-container">
                <div class="row">
                  <!-- Title Start -->
                  <div class="col">
                    <h1 class="mb-0 pb-0 display-4" id="title">Upload New Courses</h1>
                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                      <ul class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="/admin">Learning</a></li>
                        <li class="breadcrumb-item"><a href="/courses">All Courses</a></li>
                        <li class="breadcrumb-item"><a href="Pages.Profile.html">Upload</a></li>
                      </ul>
                    </nav>
                  </div>
                  <!-- Title End -->
                      ...
                      <div class="mb-2">
                        ...
                        <div>
                          <a class="nav-link active py-1 my-1 px-0" href="#">
                            ...
                            <span class="align-middle">New Courses</span>
                          </a>
                        </div>
                      </div>
                    <!-- In Page Menu End -->
              ...
              <div class="card mb-5">
                <div class="card-body">
                  <form>
                    <div class="mb-3 row">
                      <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Judul</label>
                      <div class="col-sm-8 col-md-9 col-lg-10">
                        <input type="text" class="form-control" value="?" />
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Deskripsi</label>
                      <div class="col-sm-8 col-md-9 col-lg-10">
                        <input type="text" class="form-control" value="?" />
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Thumbnail</label>
                      <div class="col-sm-8 col-md-9 col-lg-10">
